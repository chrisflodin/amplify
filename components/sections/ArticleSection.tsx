...
export default function ArticlesSection() {
  ...
  return (
    <section id="artiklar" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-inter font-bold text-brand-black mb-4">
            Senaste artiklarna
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Läs våra senaste insights om digital utveckling, design och teknik
          </p>
        </div>
